...
Public Class Compra
    ...
    Private Sub COMPRA_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DbSql = New SqlConnection("Data Source=DESKTOP-2T50KML;Initial Catalog=NAMING;Integrated Security=True")
        DbSql.Open()
        GeneraTabladeVenta()
        txtCantidad.Text = 0
    ...
    Public Sub GrabaVenta()
        ...
        Comm.CommandText = "insert into COMPRAS(Id_Orden,IdArticulo,FechaCompra,Cantidad,Status)" & "values(@Id_Orden,@Id_Articulo,@FechaCompra,@Cantidad,@Status)"
        Comm.CommandType = CommandType.Text
